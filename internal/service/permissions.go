...
func DefaultPermissionSetForRole(role string) PermissionSet {
	...
	return PermissionSet{
		...
		APIPermissions: NormalizeAPIPermissions([]string{
			...
			APIPermissionKey("POST", "/api/image-conversations"),
			APIPermissionKey("PATCH", "/api/image-conversations"),
			APIPermissionKey("DELETE", "/api/image-conversations"),
			APIPermissionKey("GET", "/api/images"),
			APIPermissionKey("PATCH", "/api/images/visibility"),
			APIPermissionKey("PATCH", "/api/images/prompt-metadata"),
			APIPermissionKey("GET", "/api/prompts"),
			APIPermissionKey("POST", "/api/prompts"),
			APIPermissionKey("PATCH", "/api/prompts"),
			APIPermissionKey("DELETE", "/api/prompts"),
